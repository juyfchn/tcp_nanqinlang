...
install_image(){
	...
	[[ ! -f kernel-ml-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget ccnu.kiwi/kernel-ml-4.12.10-1.el6.elrepo.x86_64.rpm
...
install_devel(){
	...
	[[ ! -f kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget ccnu.kiwi/kernel-ml-devel-4.12.10-1.el6.elrepo.x86_64.rpm
...
install_headers(){
	...
	[[ ! -f kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget ccnu.kiwi/kernel-ml-headers-4.12.10-1.el6.elrepo.x86_64.rpm
